    ...
    <div className="w-full bg-white shadow-lg rounded-t-[24px]">
      ...
      <div className="p-4 flex justify-end gap-2 border-t">
        <button
          ...
          className="px-6 py-3 bg-[#E2E8F0] text-[#64748B] rounded-xl font-bold"
        >
          초기화
        </button>
        <button
          onClick={applyFilters}
          className="px-8 py-3 bg-[#3B82F6] text-white rounded-xl font-bold"
        >
          결과 적용
        </button>
      </div>
...
function TabHeader({
  ...
  return (
    <button
      onClick={onClick}
      className={cn(
        "flex-1 py-4 flex items-center justify-center gap-1 text-[14px] font-bold",
