...
const NAV_ITEMS = [
  {
    ...
    sortType: "DEADLINE",
    image: "/images/quick-deadline.png",
  },
  {
    title: "새로 올라온 공고",
    description: "가장 최근 새로 올라온 공고 보러가기",
    sortType: "LATEST",
    image: "/images/quick-new.png",
  },
  {
    title: "지금 핫한 인기 공고",
    description: "조회수가 높은 지금 핫한 인기 공고 보러가기",
    sortType: "RELEVANCE",
    image: "/images/quick-hot.png",
  },
] as const;
      ...
      <div className="flex flex-col gap-3">
        {NAV_ITEMS.map((item) => (
          <Card
            ...
            padding="medium"
            shadow="sm"
            className="w-full flex items-center justify-between text-left hover:bg-slate-50 transition-all border-slate-100 rounded-2xl active:scale-[0.98]"
          >
